...
var _user$project$TTown$linspace = F3(
	function (start, end, n) {
		var n_ = _elm_lang$core$Basics$toFloat(n);
		var xs = A2(
			_elm_lang$core$List$map,
			function (x) {
				return _elm_lang$core$Basics$toFloat(x) / (n_ - 1);
			},
...
var _user$project$TTown$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$TTown$headSrc = 'http://i.imgur.com/HlKRt0C.png';
var _user$project$TTown$skySrc = 'http://i.imgur.com/7Seymp8.png';
var _user$project$TTown$landSrc = 'http://i.imgur.com/Lzsspw1.png';
var _user$project$TTown$presidentStyle = function (z) {
	return _user$project$TTown$styles(
		{
			ctor: '::',
...
var _user$project$TTown$inflatePresident = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2.size;
	var pct = function (x) {
		return _rtfeldman$elm_css$Css$pct(x * 100);
	};
	var deg = _rtfeldman$elm_css$Css$deg(_p2.angle * (-180 / _elm_lang$core$Basics$pi));
	var style = _user$project$TTown$styles(
		A2(
			F2(
				function (x, y) {
					return {ctor: '::', _0: x, _1: y};
			...
			_rtfeldman$elm_css$Css$transforms(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$rotate(deg),
					_1: {ctor: '[]'}
				}),
			{
				ctor: '::',
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src(_user$project$TTown$headSrc),
			_1: {
				ctor: '::',
				_0: _user$project$TTown$presidentStyle(2),
				_1: {
					ctor: '::',
					_0: style,
					_1: {ctor: '[]'}
...
var _user$project$TTown$inlayStyle = function (z) {
	return _user$project$TTown$styles(
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
...
var _user$project$TTown$boxStyle = _user$project$TTown$styles(
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$width(
						_rtfeldman$elm_css$Css$px(771)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$height(
							_rtfeldman$elm_css$Css$px(459)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$TTown$view = function (model) {
	var presidents = A2(_elm_lang$core$List$map, _user$project$TTown$inflatePresident, model.presidents);
	var sky = A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src(_user$project$TTown$skySrc),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('sky'),
				_1: {
					ctor: '::',
					_0: _user$project$TTown$inlayStyle(1),
					_1: {ctor: '[]'}
				}
			}
		},
	...
	var land = A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src(_user$project$TTown$landSrc),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('land'),
				_1: {
					ctor: '::',
					_0: _user$project$TTown$inlayStyle(3),
					_1: {ctor: '[]'}
				}
			}
		},
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('house'),
			_1: {
				ctor: '::',
				_0: _user$project$TTown$boxStyle,
				_1: {ctor: '[]'}
			}
		},
		A2(
...
var _user$project$TTown$emptyPresident = {x: 0, y: 0, angle: 0, size: 0, species: _elm_lang$core$Maybe$Nothing};
var _user$project$TTown$Model = F2(
	function (a, b) {
		return {time: a, presidents: b};
	});
var _user$project$TTown$CircleData = F5(
	function (a, b, c, d, e) {
		return {delta: a, speed: b, radius: c, center: d, size: e};
	});
var _user$project$TTown$President = F5(
	function (a, b, c, d, e) {
		return {x: a, y: b, angle: c, size: d, species: e};
	});
var _user$project$TTown$Circle = function (a) {
	return {ctor: 'Circle', _0: a};
};
var _user$project$TTown$vomit = F2(
	function (time, _p4) {
		var _p5 = _p4;
		var _p10 = _p5.speed;
		var _p9 = _p5.radius;
		var _p8 = _p5.delta;
		var trueSize = function () {
			var _p6 = _p5.size;
			switch (_p6.ctor) {
				case 'Small':
					return 5.0e-2;
		...
		var heading = (_elm_lang$core$Native_Utils.cmp(_p10, 0) > 0) ? 0 : _elm_lang$core$Basics$pi;
		var angle = ((time * _p10) + _p8) + heading;
		var _p7 = _p5.center;
		var x0 = _p7._0;
		var y0 = _p7._1;
		var x = ((_elm_lang$core$Basics$cos((time * _p10) + _p8) * _p9) + x0) - (trueSize / 2);
		var y = ((_elm_lang$core$Basics$sin((time * _p10) + _p8) * _p9) + y0) - (trueSize / 2);
		return {
			x: x,
			y: y,
			angle: angle,
			size: trueSize,
			species: _elm_lang$core$Maybe$Just(
				_user$project$TTown$Circle(_p5))
		};
	});
var _user$project$TTown$Moon = {ctor: 'Moon'};
var _user$project$TTown$redMoonRising = function (time) {
	...
	return {
		...
		angle: 0.1,
		size: 0.8,
		species: _elm_lang$core$Maybe$Just(_user$project$TTown$Moon)
	};
};
var _user$project$TTown$updatePresident = F2(
	function (time, president) {
		var _p11 = president.species;
		if (_p11.ctor === 'Just') {
			if (_p11._0.ctor === 'Moon') {
				return _user$project$TTown$redMoonRising(time);
			} else {
				return A2(_user$project$TTown$vomit, time, _p11._0._0);
			}
		} else {
			return _user$project$TTown$emptyPresident;
		}
	});
var _user$project$TTown$update = F2(
	function (action, model) {
		var _p12 = action;
		var time = model.time + (_p12._0 / 1000);
		var presidents = A2(
			_elm_lang$core$List$map,
			_user$project$TTown$updatePresident(time),
			model.presidents);
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Native_Utils.update(
				model,
				{time: time, presidents: presidents}),
			{ctor: '[]'});
	});
var _user$project$TTown$Yuge = {ctor: 'Yuge'};
var _user$project$TTown$Large = {ctor: 'Large'};
var _user$project$TTown$Medium = {ctor: 'Medium'};
var _user$project$TTown$Small = {ctor: 'Small'};
var _user$project$TTown$defaultCircleData = {
	delta: 0,
	speed: 0.5,
	radius: 0.5,
	center: {ctor: '_Tuple2', _0: 0, _1: 0},
	size: _user$project$TTown$Small
};
var _user$project$TTown$presidentialWave = function (flag) {
	var pres = {x: 0, y: 0, angle: 0, size: 0, species: _elm_lang$core$Maybe$Nothing};
	var sizes = {
		ctor: '::',
		_0: _user$project$TTown$Small,
		_1: {
			ctor: '::',
			_0: _user$project$TTown$Small,
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$TTown$Medium,
					_1: {
						ctor: '::',
						_0: _user$project$TTown$Medium,
						_1: {
							ctor: '::',
							_0: _user$project$TTown$Large,
							_1: {
								ctor: '::',
								_0: _user$project$TTown$Yuge,
								_1: {ctor: '[]'}
							}
						}
					}
	...
	var sizeMod = function (r) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$TTown$Small,
	...
	var _p13 = flag ? {ctor: '_Tuple3', _0: 1.2, _1: 1.2, _2: -0.5} : {ctor: '_Tuple3', _0: -0.5, _1: 1.2, _2: 0.5};
	var x0 = _p13._0;
	var maxR = _p13._1;
	var speed = _p13._2;
	var n = 20;
	...
	var radii = A2(
		...
		'radii',
		A3(_user$project$TTown$linspace, minR, maxR, n));
	var y0 = 0.2;
	var circleData = {
		delta: _elm_lang$core$Basics$pi,
		speed: speed,
		radius: 0,
		center: {ctor: '_Tuple2', _0: x0, _1: y0},
		size: _user$project$TTown$Medium
	};
	return A2(
		_elm_lang$core$List$map,
		function (cd) {
	...
	presidents: A2(
		_elm_lang$core$Basics_ops['++'],
		{
			...
			_0: _elm_lang$core$Native_Utils.update(
				_user$project$TTown$emptyPresident,
				{
					species: _elm_lang$core$Maybe$Just(_user$project$TTown$Moon)
				}),
			_1: {
				...
				_0: _elm_lang$core$Native_Utils.update(
					...
					{
						species: _elm_lang$core$Maybe$Just(
							_user$project$TTown$Circle(_user$project$TTown$defaultCircleData))
					}),
				_1: {ctor: '[]'}
			}
		},
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$TTown$presidentialWave(true),
			_user$project$TTown$presidentialWave(false)))
};
var _user$project$TTown$Animate = function (a) {
	return {ctor: 'Animate', _0: a};
};
var _user$project$TTown$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$TTown$Animate),
			_1: {ctor: '[]'}
		});
};
var _user$project$TTown$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$TTown$init,
			{ctor: '[]'}),
		update: _user$project$TTown$update,
		view: _user$project$TTown$view,
		subscriptions: _user$project$TTown$subscriptions
	})();

var Elm = {};
Elm['TTown'] = Elm['TTown'] || {};
if (typeof _user$project$TTown$main !== 'undefined') {
    _user$project$TTown$main(Elm['TTown'], 'TTown', undefined);
}
